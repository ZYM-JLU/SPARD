...
def set_args():
    ...
    parser.add_argument('--cfg', default='amass', help='h36m or amass')
    ...
    parser.add_argument('--augumentation', type=int, default=30)
    ...
    parser.add_argument('--refine_n_pre', type=int, default=150)
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.distill_ckpt:
            ckpt = torch.load(args.distill_ckpt, map_location=torch.device(cfg.device))
            model.load_state_dict(ckpt)
