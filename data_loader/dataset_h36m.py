...
import numpy as np
import pandas as pd
from data_loader.skeleton import SkeletonH36M
...
class DatasetH36M(Dataset):
    def __init__(self, mode, t_his, t_pred, segments_path=None, actions='all', augmentation=0, stride=1, transform=None,
                 dtype='float32', *args, **kwargs):
        self.mode = mode
        self.t_his = t_his
        self.t_pred = t_pred
    ...
    def _prepare_data(self):
        self.data_file = os.path.join('./data/h36m/', 'data_3d_h36m.npz')
    ...
    def _generate_segments(self):
        ...
        both = [((idx, init, init + self.t_total - 1), self.clip_idx_to_metadata[idx]) for idx in
